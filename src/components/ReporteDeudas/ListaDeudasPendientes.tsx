...
const ListaDeudasPendientes: React.FC<ListaDeudasPendientesProps> = ({
  ...
  const columns: readonly Column[] = [
    ...
    ...(mostrarPuesto ? [{ id: "numero_puesto" as const, label: "Puesto", minWidth: 70, align: "center" as const }] : []),
      ...
      <TableContainer sx={{ maxHeight: "100%", borderRadius: "5px", border: "none" }}>
        <Table stickyHeader aria-label="sticky table">
          ...
          {!isTablet && !isMobile && deudas.length > 0 && (
            <TableHead>
              <TableRow>
                <TableCell colSpan={columns.length - 3} align="right" sx={{ fontWeight: "bold", backgroundColor: "#f0f0f0" }}>
                  TOTAL:
                </TableCell>
