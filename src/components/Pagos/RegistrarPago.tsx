...
import { AgregarProps, Column, Deuda, Puesto, Socio, DeudaPendiente } from "../../interface/Pagos/RegistrarPagos";
...
const RegistrarPago: React.FC<AgregarProps> = ({ open, handleClose, pago }) => {
